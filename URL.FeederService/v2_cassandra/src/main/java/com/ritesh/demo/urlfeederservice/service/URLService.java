        ...
        for(URL url: urls){
            try {
                ...
                if(!existingurlOpt.isEmpty())
                {
                    ...
                    if(existingurl.getLastModified().getTime() + TimeUnit.DAYS.toMillis(cooldown) > System.currentTimeMillis()){
                ...
                url.setLastModified(new Timestamp(System.currentTimeMillis()));
